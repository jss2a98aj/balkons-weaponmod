...
public class AdvancedExplosion extends Explosion {
    ...
    public void doEntityExplosion(DamageSource damagesource) {
        ...
        List<Entity> list = worldObj
                .getEntitiesWithinAABBExcludingEntity(exploder, AxisAlignedBB.getBoundingBox(i0, j0, k0, i1, j1, k1));
                ...
                for (k = 0; k < maxsize; k++) {
                    if (i == 0 || i == maxsize - 1 || j == 0 || j == maxsize - 1 || k == 0 || k == maxsize - 1) {
                        ...
                        for (float f = 0.3F; strength > 0.0F; strength -= f * 0.75F) {
                            ...
                            if (block != null) {
                                strength -= (block.getExplosionResistance(
                                        exploder,
                                        worldObj,
                                        x,
                                        y,
