...
public class BalkonsWeaponMod {
    ...
    private void addModItems() {
        ...
        if (modConfig.isEnabled("katana")) {
            ...
            katanaDiamond = new ItemMelee(
                    "katana.diamond",
                    new MeleeComponent(MeleeSpecs.KATANA, Item.ToolMaterial.EMERALD));
        }
        ...
        if (modConfig.isEnabled("musket")) {
            if (modConfig.isEnabled("knife")) {
                bayonetWood = new ItemMusket(
                        "musketbayonet.wood",
                        new MeleeCompKnife(Item.ToolMaterial.WOOD),
                        knifeWood);
                bayonetStone = new ItemMusket(
                        "musketbayonet.stone",
                        new MeleeCompKnife(Item.ToolMaterial.STONE),
                        knifeStone);
                bayonetSteel = new ItemMusket(
                        "musketbayonet.iron",
                        new MeleeCompKnife(Item.ToolMaterial.IRON),
                        knifeSteel);
                bayonetGold = new ItemMusket(
                        "musketbayonet.gold",
                        new MeleeCompKnife(Item.ToolMaterial.GOLD),
                        knifeGold);
                bayonetDiamond = new ItemMusket(
                        "musketbayonet.diamond",
                        new MeleeCompKnife(Item.ToolMaterial.EMERALD),
                        knifeDiamond);
            }
    ...
    private void registerWeapons() {
        if (modConfig.isEnabled("spear")) {
            GameRegistry
                    .addRecipe(new ShapedOreRecipe(spearWood, "  #", " X ", "X  ", 'X', "stickWood", '#', "plankWood"));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(spearStone, "  #", " X ", "X  ", 'X', "stickWood", '#', Blocks.cobblestone));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(spearSteel, "  #", " X ", "X  ", 'X', "stickWood", '#', "ingotIron"));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(spearDiamond, "  #", " X ", "X  ", 'X', "stickWood", '#', "gemDiamond"));
            GameRegistry
                    .addRecipe(new ShapedOreRecipe(spearGold, "  #", " X ", "X  ", 'X', "stickWood", '#', "ingotGold"));
        ...
        if (modConfig.isEnabled("halberd")) {
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(halberdWood, " ##", " X#", "X  ", 'X', "stickWood", '#', "plankWood"));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(halberdStone, " ##", " X#", "X  ", 'X', "stickWood", '#', Blocks.cobblestone));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(halberdSteel, " ##", " X#", "X  ", 'X', "stickWood", '#', "ingotIron"));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(halberdDiamond, " ##", " X#", "X  ", 'X', "stickWood", '#', "gemDiamond"));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(halberdGold, " ##", " X#", "X  ", 'X', "stickWood", '#', "ingotGold"));
        }
        ...
        if (modConfig.isEnabled("knife")) {
            ...
            GameRegistry.addRecipe(new ShapedOreRecipe(knifeWood, "#", "X", 'X', "stickWood", '#', "plankWood"));
            GameRegistry
                    .addRecipe(new ShapedOreRecipe(knifeStone, "#", "X", 'X', "stickWood", '#', Blocks.cobblestone));
            GameRegistry.addRecipe(new ShapedOreRecipe(knifeSteel, "#", "X", 'X', "stickWood", '#', "ingotIron"));
            GameRegistry.addRecipe(new ShapedOreRecipe(knifeDiamond, "#", "X", 'X', "stickWood", '#', "gemDiamond"));
            GameRegistry.addRecipe(new ShapedOreRecipe(knifeGold, "#", "X", 'X', "stickWood", '#', "ingotGold"));
        ...
        if (modConfig.isEnabled("musket")) {
            ...
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(musket_iron_part, "XX#", "  X", 'X', "ingotIron", '#', Items.flint_and_steel));
        }

        if (modConfig.isEnabled("musket") || modConfig.isEnabled("flintlock")) {
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                            new ItemStack(musketBullet, 8),
                            "X",
                            "#",
                            "O",
                            'X',
        ...
        if (modConfig.isEnabled("battleaxe")) {
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(battleaxeWood, "###", "#X#", " X ", 'X', "stickWood", '#', "plankWood"));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                            battleaxeStone,
                            "###",
                            ...
                            Blocks.cobblestone));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(battleaxeSteel, "###", "#X#", " X ", 'X', "stickWood", '#', "ingotIron"));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(battleaxeDiamond, "###", "#X#", " X ", 'X', "stickWood", '#', "gemDiamond"));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(battleaxeGold, "###", "#X#", " X ", 'X', "stickWood", '#', "ingotGold"));
        }

        if (modConfig.isEnabled("warhammer")) {
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(warhammerWood, "#X#", "#X#", " X ", 'X', "stickWood", '#', "plankWood"));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                            warhammerStone,
                            "#X#",
                            ...
                            Blocks.cobblestone));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(warhammerSteel, "#X#", "#X#", " X ", 'X', "stickWood", '#', "ingotIron"));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(warhammerDiamond, "#X#", "#X#", " X ", 'X', "stickWood", '#', "gemDiamond"));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(warhammerGold, "#X#", "#X#", " X ", 'X', "stickWood", '#', "ingotGold"));
        }
        ...
        if (modConfig.isEnabled("crossbow")) {
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                            ...
                            Items.bow));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(new ItemStack(bolt, 4), "#", "X", 'X', Items.feather, '#', "ingotIron"));
        ...
        if (modConfig.isEnabled("blowgun")) {
            ...
            for (DartType type : DartType.dartTypes) {
                if (type != null) {
                    GameRegistry.addRecipe(
                            new ShapedOreRecipe(
                                    new ItemStack(dart, 4, type.typeID),
                                    "#",
                                    "X",
                                    "O",
                                    'X',
        ...
        if (modConfig.isEnabled("firerod")) {
            GameRegistry
                    .addRecipe(new ShapedOreRecipe(fireRod, "#  ", " X ", "  X", 'X', "stickWood", '#', Blocks.torch));
        }
        ...
        if (modConfig.isEnabled("cannon")) {
            ...
            GameRegistry
                    .addRecipe(new ShapedOreRecipe(new ItemStack(cannonBall, 4), " X ", "XXX", " X ", 'X', "stone"));
            EntityRegistry.registerModEntity(EntityCannonBall.class, "cannonball", 10, this, 64, 20, true);
        }

        if (modConfig.isEnabled("blunderbuss")) {
            GameRegistry.addRecipe(
                    new ItemStack(blunderShot, 8),
                    "X",
                    "#",
                    "O",
                    'X',
        ...
        if (modConfig.isEnabled("boomerang")) {
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(boomerangWood, "XX#", "  X", "  X", 'X', "plankWood", '#', "plankWood"));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                            boomerangStone,
                            "XX#",
                            ...
                            Blocks.cobblestone));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(boomerangSteel, "XX#", "  X", "  X", 'X', "plankWood", '#', "ingotIron"));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(boomerangDiamond, "XX#", "  X", "  X", 'X', "plankWood", '#', "gemDiamond"));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(boomerangGold, "XX#", "  X", "  X", 'X', "plankWood", '#', "ingotGold"));
        ...
        if (modConfig.isEnabled("katana")) {
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(katanaWood, "  #", " # ", "X  ", 'X', "stickWood", '#', "plankWood"));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(katanaStone, "  #", " # ", "X  ", 'X', "stickWood", '#', Blocks.cobblestone));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(katanaSteel, "  #", " # ", "X  ", 'X', "stickWood", '#', "ingotIron"));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(katanaDiamond, "  #", " # ", "X  ", 'X', "stickWood", '#', "gemDiamond"));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(katanaGold, "  #", " # ", "X  ", 'X', "stickWood", '#', "ingotGold"));
        }
    ...
    /*
     * @Override public int dispense(int x, int y, int z, int xVel, int zVel, World world, ItemStack item, Random
     * random, double entX, double entY, double entZ) { if (musketBullet != null && item.itemID ==
     * musketBullet.shiftedIndex) { EntityMusketBullet entitymusketbullet = new EntityMusketBullet(world, x, y, z);
     * entitymusketbullet.setThrowableHeading(xVel, 0.0D, zVel, 5.0F, 3.0F);
     * world.spawnEntityInWorld(entitymusketbullet); world.playSoundEffect(x, y, z, "random.explode", 3.0F, 1.0F /
     * (rand.nextFloat() * 0.4F + 0.7F)); world.playSoundEffect(x, y, z, "ambient.weather.thunder", 3.0F, 1.0F /
     * (rand.nextFloat() * 0.4F + 0.4F)); world.spawnParticle("flame", x + xVel, y, z + zVel, 0.0D, 0.0D, 0.0D); } else
     * if (javelin != null && item.itemID == javelin.shiftedIndex) { EntityJavelin entityjavelin = new
     * EntityJavelin(world, x, y, z); entityjavelin.setPickupMode(EntityProjectile.PICKUP_ALL);
     * entityjavelin.setThrowableHeading(xVel, 0.1D, zVel, 1.1F, 4.0F); world.spawnEntityInWorld(entityjavelin);
     * world.playSoundEffect(x, y, z, "random.bow", 1.0F, 1.2F); } else if (bolt != null && item.itemID ==
     * bolt.shiftedIndex) { EntityCrossbowBolt entitycrossbowbolt = new EntityCrossbowBolt(world, x, y, z);
     * entitycrossbowbolt.setPickupMode(EntityProjectile.PICKUP_ALL); entitycrossbowbolt.setThrowableHeading(xVel, 0.0D,
     * zVel, 5.0F, 4.0F); world.spawnEntityInWorld(entitycrossbowbolt); world.playSoundEffect(x, y, z, "random.bow",
     * 1.0F, 1.2F); } else if (dart != null && item.itemID == dart.shiftedIndex) { EntityBlowgunDart entityblowgundart =
     * new EntityBlowgunDart(world, x, y, z); entityblowgundart.setPickupMode(EntityProjectile.PICKUP_ALL);
     * entityblowgundart.setThrowableHeading(xVel, 0.0D, zVel, 5.0F, 4.0F); world.spawnEntityInWorld(entityblowgundart);
     * world.playSoundEffect(x, y, z, "random.bow", 1.0F, 1.2F); } else if (dynamite != null && item.itemID ==
     * dynamite.shiftedIndex) { EntityDynamite entitydynamite = new EntityDynamite(world, x, y, z);
     * entitydynamite.setThrowableHeading(xVel, 0.1D, zVel, 1.0F, 4.0F); world.spawnEntityInWorld(entitydynamite);
     * world.playSoundEffect(x, y, z, "random.fuse", 1.0F, 1.2F); } else if (blunderShot != null && item.itemID ==
     * blunderShot.shiftedIndex) { EntityBlunderShot.fireFromDispenser(world, x, y, z, xVel, zVel);
     * world.playSoundEffect(x, y, z, "random.old_explode", 3.0F, 1.0F / (rand.nextFloat() * 0.4F + 1.0F));
     * world.spawnParticle("flame", x + xVel, y, z + zVel, 0.0D, 0.0D, 0.0D); } else if
     * (WeaponRegistry.isEnabled("cannon") && (item.itemID == cannonBall.shiftedIndex || item.itemID ==
     * Items.gunpowder.shiftedIndex)) { boolean canfire = false; TileEntity tileentity =
     * world.getBlockTileEntity(MathHelper.floor_double(x - xVel), MathHelper.floor_double(y), MathHelper.floor_double(z
     * - zVel)); if (tileentity instanceof TileEntityDispenser) { TileEntityDispenser dispenser = ((TileEntityDispenser)
     * tileentity); int itemtocheck = 0; if (item.itemID == Items.gunpowder.shiftedIndex) { itemtocheck =
     * cannonBall.shiftedIndex; } else if (item.itemID == cannonBall.shiftedIndex) { itemtocheck =
     * Items.gunpowder.shiftedIndex; } int k; for (k = 0; k < dispenser.getSizeInventory(); k++) { ItemStack itemstack1
     * = dispenser.getStackInSlot(k); if (itemstack1 != null && itemstack1.itemID == itemtocheck) {
     * dispenser.decrStackSize(k, 1); canfire = true; break; } } } if (!canfire) return 0; EntityCannonBall
     * entitycannonball = new EntityCannonBall(world, x, y, z); entitycannonball.setThrowableHeading(xVel, 0.1D, zVel,
     * 2.0F, 2.0F); world.spawnEntityInWorld(entitycannonball); world.playSoundEffect(x, y, z, "random.explode", 8.0F,
     * 1.0F / (rand.nextFloat() * 0.8F + 0.9F)); world.playSoundEffect(x, y, z, "ambient.weather.thunder", 8.0F, 1.0F /
     * (rand.nextFloat() * 0.4F + 0.6F)); world.spawnParticle("flame", x + xVel, y, z + zVel, 0.0D, 0.0D, 0.0D); } else
     * return 0; return -1; }
     */
}
