...
public abstract class WeaponModResources {
    ...
    public static abstract class Textures {
        ...
        public static final ResourceLocation BOLT = new ResourceLocation(
                "weaponmod",
                "textures/entity/crossbow_bolt.png");
        ...
        public static final ResourceLocation BULLET = new ResourceLocation(
                "weaponmod",
                "textures/entity/musket_bullet.png");
        ...
        public static final ResourceLocation ENCHANTMENT_GLINT = new ResourceLocation(
                "minecraft",
                "%blur%/misc/enchanted_item_glint.png");
