...
public class EntityCannonBall extends EntityProjectile {
    ...
    public EntityCannonBall(World world, EntityCannon entitycannon, boolean superPowered) {
        ...
        setLocationAndAngles(
                entitycannon.posX,
                entitycannon.posY + 1.0D,
                entitycannon.posZ,
                entitycannon.riddenByEntity.rotationYaw,
                entitycannon.riddenByEntity.rotationPitch);
    ...
    public void createCrater() {
        ...
        PhysHelper.createAdvancedExplosion(
                ...
                posZ,
                f,
                BalkonsWeaponMod.instance.modConfig.cannonDoesBlockDamage,
                true);
    }
