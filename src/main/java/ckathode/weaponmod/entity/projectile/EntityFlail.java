...
public class EntityFlail extends EntityMaterialProjectile {
    ...
    public void returnToOwner(Entity entity, boolean looseFromGround) {
        ...
        float f = 27F;
        float f1 = 2F;
        targetPosX += -Math.sin(((shootingEntity.rotationYaw + f) / 180F) * Math.PI)
                * Math.cos((shootingEntity.rotationPitch / 180F) * Math.PI)
                * f1;
        targetPosZ += Math.cos(((shootingEntity.rotationYaw + f) / 180F) * Math.PI)
                * Math.cos((shootingEntity.rotationPitch / 180F) * Math.PI)
                * f1;
    ...
    public void swing() {
        ...
        motionX = -MathHelper.sin(((shootingEntity.rotationYaw) / 180F) * 3.141593F)
                * MathHelper.cos((shootingEntity.rotationPitch / 180F) * 3.141593F);
        motionY = -MathHelper.sin((shootingEntity.rotationPitch / 180F) * 3.141593F);
        motionZ = MathHelper.cos(((shootingEntity.rotationYaw) / 180F) * 3.141593F)
                * MathHelper.cos((shootingEntity.rotationPitch / 180F) * 3.141593F);
