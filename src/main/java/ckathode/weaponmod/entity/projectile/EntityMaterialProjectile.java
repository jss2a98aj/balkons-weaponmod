...
public abstract class EntityMaterialProjectile extends EntityProjectile {
    ...
    private static final float[][] MATERIAL_COLORS = { { 0.6F, 0.4F, 0.1F }, { 0.5F, 0.5F, 0.5F }, { 1.0F, 1.0F, 1.0F },
            { 0.0F, 0.8F, 0.7F }, { 1.0F, 0.9F, 0.0F } };
    ...
    public float getMeleeHitDamage(Entity entity) {
        if (shootingEntity instanceof EntityLivingBase && entity instanceof EntityLivingBase) {
            return EnchantmentHelper
                    .getEnchantmentModifierLiving((EntityLivingBase) shootingEntity, (EntityLivingBase) entity);
        }
        return 0F;
    }
    ...
    public void applyEntityHitEffects(Entity entity) {
        ...
        if (shootingEntity instanceof EntityLivingBase && entity instanceof EntityLivingBase) {
            int i = EnchantmentHelper
                    .getKnockbackModifier((EntityLivingBase) shootingEntity, (EntityLivingBase) entity);
            if (i != 0) {
                entity.addVelocity(
                        -MathHelper.sin(rotationYaw * (float) Math.PI / 180.0F) * i * 0.5F,
                        0.1D,
    ...
    protected final void updateWeaponMaterial() {
        if (thrownItem != null && thrownItem.getItem() instanceof IItemWeapon
                && ((IItemWeapon) thrownItem.getItem()).getMeleeComponent() != null) {
