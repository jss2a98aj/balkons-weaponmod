...
public class MeleeCompBattleaxe extends MeleeComponent {
    ...
    public void addItemAttributeModifiers(Multimap<String, AttributeModifier> multimap) {
        ...
        multimap.put(
                WeaponModAttributes.IGNORE_ARMOUR_DAMAGE.getAttributeUnlocalizedName(),
                new AttributeModifier(weapon.getUUID(), "Weapon ignore armour modifier", ignoreArmourAmount, 0));
    }
}
